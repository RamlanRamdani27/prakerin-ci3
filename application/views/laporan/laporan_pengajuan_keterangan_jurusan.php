            ...
            <div id="notifications"><?php echo $this->session->flashdata('msg'); ?></div>
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <?php
                            if($this->uri->segment(2)=="laporan_ditolak_jurusan"){
                                $link="laporan_ditolak_jurusan";
                            }else{
                                $link="laporan_diterima_jurusan";
                            }
                        ?>
                        <div class="body">
                        <div class="table-responsive">
                            <form id="form_validation" enctype="multipart/form-data" method="POST" action="<?=base_url()?>laporan/<?=$link?>">
