    ...
    <div class="login-box">
        ...
        <div class="card">
            ...
            <div id="notifications"><?php echo $this->session->flashdata('msg'); ?></div>
                <form id="sign_in" method="POST" novalidate="novalidate" action="<?php echo base_url()?>/login/ceklogin">
                    <div class="msg">Admin Sistem Informasi<b> Prakerin</b></div>
                    <div class="input-group">
                        <span class="input-group-addon">
                            <i class="material-icons">person</i>
                        </span>
                        <div class="form-line">
                            <input type="text" class="form-control" name="txtusername" placeholder="Username" required="" autofocus="" aria-required="true">
                        </div>
                    </div>
                    <div class="input-group">
                        <span class="input-group-addon">
