                                    ...
                                    <tbody>
                                      <?php                                                                                                       
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                            <a class="btn btn-xs btn-primary" href="javascript:void(0)" title="Edit" onclick="edit_person('<?=$row->idbidang;?>')"><i class="glyphicon glyphicon-pencil"></i> </a>
                                            <a class="btn btn-xs btn-danger hapus-jurusan" href='<?=base_url().'/bidang/ajax_delete/'. $row->idbidang;?>'><i class="glyphicon glyphicon-trash"></i> </a>
                                            </td>
                                        </tr>
                                            <?php
                                            $no++;
...
$(document).on("click",".hapus-jurusan",function(){
    ...
    swal({
        title:"Alert",
        text:"Yakin akan menghapus Bidang ini?",
        type: "warning",
