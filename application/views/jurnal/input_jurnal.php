            ...
            <div class="row clearfix">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form id="form_validation" enctype="multipart/form-data" method="POST" action="<?=base_url()?>jurnal/insert_data">
                                <div class="form-group form-float">
                                 <label class="form-label">ID Jurnal</label>
                                    <div class="form-line">
                                       <input type="text" class="form-control" name="id" placeholder="" value="<?=$idjurnal?>" readonly>
                                    </div>
                                </div>
                                <div class="form-group form-float">
                                 <label class="form-label">Tanggal Kegiatan</label>
                                    <div class="form-line">
                                       <input type="text" class="datepicker form-control" name="tglkegiatan" placeholder="">
                                    </div>
                                </div>
                                <div class="form-group form-float">
                                <label class="form-label">Kegiatan</label>
                                    <div class="form-line">
                                        <textarea name="kegiatan" cols="30" rows="5" class="form-control no-resize" required></textarea>  
                                    </div>
                                </div>
                                <div class="form-group form-float">
