                                        ...
                                        <option value="">-- Pilih Kategori --</option>
                                          <?php
                                             foreach ($kategori as $data ) {
                                                    ...
                                                    ?>
                                                    <option <?php if($list->idkategori==$data->idkategori){echo "selected";} ?> value='<?=$data->idkategori?>'><?=$data->namakategori?></option>
                                        <?php
                                            }
                                         ?>
                                    </select>
                                    ...
                                    <select id='provinsi' class="form-control select2" required="true"> 
                                        <option value="">-- Pilih Provinsi --</option>
                                             ...
                                             foreach ($provinsi as $data ) {
                                                    ...
                                                    ?>
                                                    <option <?php if($list->id==$data->id){echo "selected";} ?> value='<?=$data->id?>'><?=$data->name?></option>
                                        <?php
                                            }
                                         ?>
                                    </select>
